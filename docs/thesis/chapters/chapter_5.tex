...
In this chapter we propose a novel framework for distributed CER that is based on CEA from Chapter~\ref{chapter:preliminaries}.
We describe two possible architectures based on this framework, and discuss several distributions strategies for each.

\section{Proposed framework}\label{sec:proposed-approach}
...
% Talk about the two different architectures and present their names

\section{Architecture I}\label{sec:prototype:I}
...
\section{Architecture II}\label{sec:prototype:II}
...
% Challenge here is the distributed algorithm of section 5
