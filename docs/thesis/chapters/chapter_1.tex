...
\todo[inline]{I think it is a better idea to use the example environment, as it makes a distinction using italics}
...
\todo[inline]{Arnau, please, fix the numbers so they make sense in your example}

\begin{figure}[h!]
	\centering{
		{
			\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|c}\hline
				type  &$H$&$T$&$H$&$H$&$T$&$H$&$T$&$H$&$H$ & \ldots \\ \hline
				id  & 1 & 2 & 2 & 3 & 1 & 2 & 1 & 3 & 2 & \multirow{2}{*}{\ldots} \\
				val & 50 & -1& 40& 35& 3& 50& -1& 45& 65\\ \hline
				timestamp & 0 & 1 & 2 & 3 & 4 & 5 & 6 & 7 & 8 & \ldots \\ \hline
		\end{tabular}}
		\caption{Exemplary stream of events measuring temperature ($T$) and relative humidity ($H$)}\label{fig:stream}
	}
\end{figure}
...
\todo[inline]{Elaborate on such partial matches using few examples using the stream above}
\end{example}
...
\todo[inline]{Is it necessary to make the distinction between the different works?}
