...
% Explain that the challenge here is implementing a distributed algorithm for CEA.
% Follow up introducing Section 5

\subsection{Distribution Strategies}\label{subsec:dcore:distribution-strategies}
