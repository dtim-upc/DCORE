...
There is only left to prove (3). We start with Lemma~\ref{lemma:paths_equivalence} and Lemma~\ref{lemma:union_of_paths} that will be essential in order to prove Theorem~\ref{theorem:enumeration}.
