...
\section{Distributed enumeration}\label{sec:distributed_enumeration}
...
The proof of Theorem~\ref{theorem:bijection} is technical and the reader may find it in the \mbox{\apref{appendix:A}}.
